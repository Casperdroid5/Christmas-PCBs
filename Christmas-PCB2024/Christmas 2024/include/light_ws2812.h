...
struct cRGB  { uint8_t b; uint8_t r; uint8_t g; };    // type 5
// struct cRGB  { uint8_t g; uint8_t r; uint8_t b; };  // type 3
...
void ws2812_setleds     (struct cRGB  *ledarray, uint16_t number_of_leds, uint8_t del);
void ws2812_setleds_pin (struct cRGB  *ledarray, uint16_t number_of_leds,uint8_t pinmask, uint8_t del);
